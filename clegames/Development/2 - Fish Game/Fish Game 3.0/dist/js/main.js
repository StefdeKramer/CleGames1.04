...
var Level = (function () {
    ...
    Level.prototype.setGameOver = function (gameOver) {
...
var ScoreDisplay = (function () {
    ...
    ScoreDisplay.prototype.gameOver = function () {
        if (this.s1 >= 1000) {
            this.div3.innerHTML = "Speler 1 heeft gewonnen!";
            this.level.setGameOver(true);
        }
        else if (this.s2 >= 1000) {
            this.div3.innerHTML = "Speler 2 heeft gewonnen!";
            this.level.setGameOver(true);
        }
    };
    return ScoreDisplay;
